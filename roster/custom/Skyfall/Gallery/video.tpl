...
<div class="container abs-center-x">
...
<div class="container">
  ...
  <div class="row">
    ...
    <!-- Grid column -->
    <div class="col-lg-4 col-md-12 mb-4" style="margin-top: 70px;">
      ...
      <a>
        <div class="text-center" style="text-align: center;"><h5>{$video.name}</h5></div>
